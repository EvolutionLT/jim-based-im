...
public class CaffeineUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		LoadingCache<String, Object> loadingCache = cn.ideamake.components.im.common.common.cache.caffeine.CaffeineUtils.createLoadingCache("mycache", timeToLiveSeconds, timeToIdleSeconds, initialCapacity, maximumSize,recordStats);
