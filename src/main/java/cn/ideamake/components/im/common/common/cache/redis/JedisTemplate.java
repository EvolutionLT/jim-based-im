...
import cn.ideamake.components.im.common.common.cache.redis.RedisLock;
...
public  class JedisTemplate implements  Serializable{  
	...
	private static final Logger logger = LoggerFactory.getLogger(cn.ideamake.components.im.common.common.cache.redis.JedisTemplate.class);
	private static volatile cn.ideamake.components.im.common.common.cache.redis.JedisTemplate instance = null;
	private static JedisPool jedisPool = null;
	private static volatile Jedis jedis = null;
	private static RedisConfiguration redisConfig = null;
	private JedisTemplate (){}
	
	public static cn.ideamake.components.im.common.common.cache.redis.JedisTemplate me() throws Exception{
		 if (instance == null) { 
	        	synchronized (cn.ideamake.components.im.common.common.cache.redis.JedisTemplate.class) {
					if(instance == null){
						redisConfig = RedisConfigurationFactory.parseConfiguration();
						init();
						instance = new cn.ideamake.components.im.common.common.cache.redis.JedisTemplate();
					}
				}
	     }
		 return instance;
