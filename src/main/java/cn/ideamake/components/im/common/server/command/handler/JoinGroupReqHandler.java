...
import cn.ideamake.components.im.common.server.command.handler.processor.group.GroupCmdProcessor;
...
public class JoinGroupReqHandler extends AbstractCmdHandler {
	...
	private static Logger log = LoggerFactory.getLogger(cn.ideamake.components.im.common.server.command.handler.JoinGroupReqHandler.class);
