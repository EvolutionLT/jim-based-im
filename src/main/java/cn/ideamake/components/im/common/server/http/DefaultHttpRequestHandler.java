...
import cn.ideamake.components.im.common.common.http.listener.IHttpServerListener;
import cn.ideamake.components.im.common.common.http.session.HttpSession;
import cn.ideamake.components.im.common.server.http.FileCache;
import cn.ideamake.components.im.common.server.http.mvc.Routes;
import cn.ideamake.components.im.common.server.util.ClassUtils;
...
public class DefaultHttpRequestHandler implements IHttpRequestHandler {
    private static Logger log = LoggerFactory.getLogger(cn.ideamake.components.im.common.server.http.DefaultHttpRequestHandler.class);
