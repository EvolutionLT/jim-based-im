...
public interface HttpConst {
	 ...
	 *         Accept-Language : zh-CN,zh;q=0.8
	  ...
	  Sec-WebSocket-Extensions : permessage-deflate; client_max_window_bits
	           ...
	           Accept-Encoding : gzip, deflate, sdch
	                UserInfo-Agent : Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36
	...
	public interface RequestHeaderKey {
		...
		String User_Agent = "UserInfo-Agent".toLowerCase(); //Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3088.3 Safari/537.36
