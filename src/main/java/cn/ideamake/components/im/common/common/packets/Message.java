...
public class Message implements Serializable{
	...
	public abstract static class Builder<T extends cn.ideamake.components.im.common.common.packets.Message, B extends cn.ideamake.components.im.common.common.packets.Message.Builder<T,B>>{
		/**
		 * 消息创建时间
		 */
		protected Long createTime;
