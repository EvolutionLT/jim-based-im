...
import cn.ideamake.components.im.common.common.cache.redis.JedisSubscriber;
...
public class SubRunnable implements Runnable {
	...
	Logger log = LoggerFactory.getLogger(cn.ideamake.components.im.common.common.cache.redis.SubRunnable.class);
