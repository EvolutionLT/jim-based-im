...
public enum MsgType {
    ...
    public static cn.ideamake.components.im.common.common.packets.MsgType valueOf(int value) {
        return forNumber(value);
    }

    public static cn.ideamake.components.im.common.common.packets.MsgType forNumber(int value) {
        switch (value) {
            case 0:
