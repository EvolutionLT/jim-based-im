...
public class RedisClusterConfig extends ImClusterConfig {
	...
	private static Logger log = LoggerFactory.getLogger(cn.ideamake.components.im.common.common.cluster.redis.RedisClusterConfig.class);
	 ...
	 * @author: WChao
	 */
	public static cn.ideamake.components.im.common.common.cluster.redis.RedisClusterConfig newInstance(String topicSuffix, RedissonClient redisson, GroupContext groupContext) {
		if (redisson == null) {
		...
		cn.ideamake.components.im.common.common.cluster.redis.RedisClusterConfig me = new cn.ideamake.components.im.common.common.cluster.redis.RedisClusterConfig(topicSuffix, redisson, groupContext);
