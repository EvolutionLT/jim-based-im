...
public class DynamicEnumUtil {
   ...
   /**
    * Add an enums instance to the enums class given as argument
    *
    * @param <T> the type of the enums (implicit)
    * @param enumType the class of the enums to be modified
    * @param enumName the name of the new enums instance to be added to the class.
    */
   ...
   public static <T extends Enum<?>> T addEnum(Class<T> enumType, String enumName, Class<?>[] additionalTypes, Object[] additionalValues) {
       ...
       // 1. Lookup "$VALUES" holder in enums class and get previous enums instances
