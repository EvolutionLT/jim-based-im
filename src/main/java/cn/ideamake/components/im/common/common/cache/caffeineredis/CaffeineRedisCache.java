...
import cn.ideamake.components.im.common.common.cache.IL2Cache;
...
public class CaffeineRedisCache implements ICache, IL2Cache {
    ...
    Logger log = LoggerFactory.getLogger(cn.ideamake.components.im.common.common.cache.caffeineredis.CaffeineRedisCache.class);
