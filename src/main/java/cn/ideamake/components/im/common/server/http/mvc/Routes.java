package cn.ideamake.components.im.common.server.http.mvc;
 ...
 */
public class Routes {
    private static Logger log = LoggerFactory.getLogger(cn.ideamake.components.im.common.server.http.mvc.Routes.class);
