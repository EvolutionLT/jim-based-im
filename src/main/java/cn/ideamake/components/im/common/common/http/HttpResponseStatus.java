...
public enum HttpResponseStatus implements Status {
    ...
    public static cn.ideamake.components.im.common.common.http.HttpResponseStatus getHttpStatus(int status) {
        cn.ideamake.components.im.common.common.http.HttpResponseStatus[] values = cn.ideamake.components.im.common.common.http.HttpResponseStatus.values();
        for (cn.ideamake.components.im.common.common.http.HttpResponseStatus v : values) {
